...
export default function StagePage() {
  ...
  useEffect(() => {
    ...
    socket.on('scene:change', (s: Scene) => { setScene(s); setPollResults(null) })
    ...
    <div style={{
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '0 80px' }}>
        <AnimatePresence mode="wait">
          {/* POLL RESULTS */}
          {(t === 'binary_poll' || t === 'multi_poll') && pollResults ? (
            <motion.div
            ...
            /* POLL QUESTION (waiting for votes) */
            <motion.div
            ...
            >
              <h2 style={{
                ...
                Trouvez votre paire quantique.
              </h2>
              <p style={{
                fontFamily: "'Inter', sans-serif", fontSize: 20,
                color: '#4A4A52', marginTop: 24,
              }}>
                Quelqu'un dans cette salle est intriqué avec vous.
              </p>
            </motion.div>
          ) : t === 'blackout' ? (
            ...
            >
              <motion.div
                style={{ width: 6, height: 6, borderRadius: '50%', background: '#E8E6E1', margin: '0 auto' }}
      ...
      <div style={{
        ...
        <span style={{
          ...
          color: '#1A1A1D', letterSpacing: '0.1em',
        }}>
          {clients} connecté{clients > 1 ? 's' : ''}
        </span>
        <span style={{
          fontFamily: "'Inter', sans-serif", fontSize: 11,
          color: '#1A1A1D', textTransform: 'uppercase', letterSpacing: '0.2em',
        }}>
          {scene?.name || ''}
        </span>
      </div>
